...
exe 'vert 1resize ' . ((&columns * 22 + 95) / 191)
exe 'vert 2resize ' . ((&columns * 142 + 95) / 191)
exe 'vert 3resize ' . ((&columns * 25 + 95) / 191)
argglobal
edit term://.//25011:nvim\ /home/cdiez50/nvim/session/current
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=

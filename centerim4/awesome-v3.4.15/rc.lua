...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modley,           }, "ù", function () global_focus_disable = not global_focus_disable end),
    awful.key({ }, "F12", function () awful.util.spawn("sh /home/cdiez50/Scripts/Local/lock.sh")end),
    ...
    awful.key({ modkey, }, "Left", function () awful.screen.focus_relative(-1,2) end),
